...
void WINAPI AntivirusService::ServiceCtrlHandler(DWORD ctrl) {
    ...
    case SERVICE_CONTROL_INTERROGATE:
        s_instance->SetServiceStatus(s_instance->m_status.dwCurrentState);
        break;
    default:
        break;
    }
...
void AntivirusService::SetServiceStatus(DWORD state, DWORD exitCode, DWORD waitHint) {
    ...
    ReportStatus(state, exitCode, waitHint);
}

void AntivirusService::ReportStatus(DWORD currentState, DWORD exitCode, DWORD waitHint) {
